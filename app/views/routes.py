...
from app.controllers.barbeiro_controller import BarbeiroController
...
from app.utils.decorators import token_required, barbeiro_required, barbeiro_chefe_required
